...
attribute shreg_extract : string;
    ...
    component design_1_v_frmbuf_rd_0_0_fifo_w13_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_0_0_fifo_w64_d1024_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_0_0_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    width_c_U : component design_1_v_frmbuf_rd_0_0_fifo_w13_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    bytePlanes_U : component design_1_v_frmbuf_rd_0_0_fifo_w64_d1024_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c9_U : component design_1_v_frmbuf_rd_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component design_1_v_frmbuf_rd_0_0_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
