...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_ENABLE_ID_PORTS" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_ID_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_DATA_WIDTH" -parent ${group_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_ENABLE_USER_PORTS" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_AWUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_WUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_BUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_ARUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_RUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_USER_VALUE" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_PROT_VALUE" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_MM_VIDEO_CACHE_VALUE" -parent ${group_0}
...
proc update_PARAM_VALUE.C_M_AXI_MM_VIDEO_DATA_WIDTH { PARAM_VALUE.C_M_AXI_MM_VIDEO_DATA_WIDTH } {
