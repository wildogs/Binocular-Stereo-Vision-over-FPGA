...
entity design_1_v_frmbuf_rd_2_0_FrmbufRdHlsDataFlow is
port (
...
architecture behav of design_1_v_frmbuf_rd_2_0_FrmbufRdHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_width_c_din : STD_LOGIC_VECTOR (12 downto 0);
    signal entry_proc_U0_width_c_write : STD_LOGIC;
    ...
    signal AXIMMvideo2Bytes_U0_height_c9_din : STD_LOGIC_VECTOR (11 downto 0);
    signal AXIMMvideo2Bytes_U0_height_c9_write : STD_LOGIC;
    ...
    signal width_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal width_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal bytePlanes_num_data_valid : STD_LOGIC_VECTOR (10 downto 0);
    signal bytePlanes_fifo_cap : STD_LOGIC_VECTOR (10 downto 0);
    signal bytePlanes_empty_n : STD_LOGIC;
    signal height_c9_full_n : STD_LOGIC;
    signal height_c9_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal height_c9_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal height_c9_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component design_1_v_frmbuf_rd_2_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        p_read : IN STD_LOGIC_VECTOR (12 downto 0);
        width_c_din : OUT STD_LOGIC_VECTOR (12 downto 0);
        width_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        width_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    component design_1_v_frmbuf_rd_2_0_AXIMMvideo2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_Bytes2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w13_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w6_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w2_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w64_d1024_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w12_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w15_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_start_for_Bytes2MultiPixStream_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_2_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component design_1_v_frmbuf_rd_2_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIMMvideo2Bytes_U0 : component design_1_v_frmbuf_rd_2_0_AXIMMvideo2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        p_read1 => p_read4,
        p_read2 => p_read2,
        height_c9_din => AXIMMvideo2Bytes_U0_height_c9_din,
        height_c9_num_data_valid => height_c9_num_data_valid,
        height_c9_fifo_cap => height_c9_fifo_cap,
        height_c9_full_n => height_c9_full_n,
        height_c9_write => AXIMMvideo2Bytes_U0_height_c9_write,
    ...
    Bytes2MultiPixStream_U0 : component design_1_v_frmbuf_rd_2_0_Bytes2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        Height_num_data_valid => height_c9_num_data_valid,
        Height_fifo_cap => height_c9_fifo_cap,
    ...
    MultiPixStream2AXIvideo_U0 : component design_1_v_frmbuf_rd_2_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    width_c_U : component design_1_v_frmbuf_rd_2_0_fifo_w13_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc_U0_width_c_din,
        if_full_n => width_c_full_n,
        if_write => entry_proc_U0_width_c_write,
    ...
    video_format_c_U : component design_1_v_frmbuf_rd_2_0_fifo_w6_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_c_U : component design_1_v_frmbuf_rd_2_0_fifo_w2_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_U : component design_1_v_frmbuf_rd_2_0_fifo_w64_d1024_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c9_U : component design_1_v_frmbuf_rd_2_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIMMvideo2Bytes_U0_height_c9_din,
        if_full_n => height_c9_full_n,
        if_write => AXIMMvideo2Bytes_U0_height_c9_write,
        if_dout => height_c9_dout,
        if_num_data_valid => height_c9_num_data_valid,
        if_fifo_cap => height_c9_fifo_cap,
        if_empty_n => height_c9_empty_n,
        if_read => Bytes2MultiPixStream_U0_Height_read);

    WidthInBytes_c_U : component design_1_v_frmbuf_rd_2_0_fifo_w15_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component design_1_v_frmbuf_rd_2_0_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c_U : component design_1_v_frmbuf_rd_2_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2MultiPixStream_U0_U : component design_1_v_frmbuf_rd_2_0_start_for_Bytes2MultiPixStream_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component design_1_v_frmbuf_rd_2_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
