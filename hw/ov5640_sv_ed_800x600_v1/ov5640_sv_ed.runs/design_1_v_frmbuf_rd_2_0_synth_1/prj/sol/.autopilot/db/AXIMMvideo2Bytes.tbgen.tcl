...
set C_modelArgList {
	...
	{ height_c9 int 12 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mm_video", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "frm_buffer","offset": { "type": "dynamic","port_name": "frm_buffer","bundle": "CTRL"},"direction": "READONLY"},{"cName": "frm_buffer2","offset": { "type": "dynamic","port_name": "frm_buffer2","bundle": "CTRL"},},{"cName": "frm_buffer3","offset": { "type": "dynamic","port_name": "frm_buffer3","bundle": "CTRL"},}]}]} , 
 	...
 	{ "Name" : "height_c9", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bytePlanes_num_data_valid sc_in sc_lv 11 signal 2 } 
	{ bytePlanes_fifo_cap sc_in sc_lv 11 signal 2 } 
	...
	{ height_c9_din sc_out sc_lv 12 signal 6 } 
	{ height_c9_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ height_c9_fifo_cap sc_in sc_lv 2 signal 6 } 
	{ height_c9_full_n sc_in sc_logic 1 signal 6 } 
	{ height_c9_write sc_out sc_logic 1 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "height_c9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "height_c9", "role": "din" }} , 
 	{ "name": "height_c9_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "height_c9", "role": "num_data_valid" }} , 
 	{ "name": "height_c9_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "height_c9", "role": "fifo_cap" }} , 
 	{ "name": "height_c9_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "height_c9", "role": "full_n" }} , 
 	{ "name": "height_c9_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "height_c9", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "mm_video", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_437_1_fu_172", "Port" : "mm_video", "Inst_start_state" : "110", "Inst_end_state" : "111"}]},
			{"Name" : "srcImg", "Type" : "None", "Direction" : "I"},
			{"Name" : "bytePlanes", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_437_1_fu_172", "Port" : "bytePlanes", "Inst_start_state" : "110", "Inst_end_state" : "111"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_read2", "Type" : "Stable", "Direction" : "I"},
			{"Name" : "height_c9", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_437_1_fu_172", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_437_1_fu_172.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "35877601"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "35877601"}
]}
...
set Spec2ImplPortList { 
	...
	height_c9 { ap_fifo {  { height_c9_din fifo_port_we 1 12 }  { height_c9_num_data_valid fifo_status_num_data_valid 0 2 }  { height_c9_fifo_cap fifo_update 0 2 }  { height_c9_full_n fifo_status 0 1 }  { height_c9_write fifo_data 1 1 } } }
