...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthOut_dout { I 13 vector } WidthOut_num_data_valid { I 3 vector } WidthOut_fifo_cap { I 3 vector } WidthOut_empty_n { I 1 bit } WidthOut_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_dout { I 2 vector } colorFormat_num_data_valid { I 3 vector } colorFormat_fifo_cap { I 3 vector } colorFormat_empty_n { I 1 bit } colorFormat_read { O 1 bit } } \
} "
}
