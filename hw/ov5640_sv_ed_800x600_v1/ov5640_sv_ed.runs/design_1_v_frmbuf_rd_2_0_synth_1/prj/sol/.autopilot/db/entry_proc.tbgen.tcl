...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "width_c", "interface" : "fifo", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ width_c_din sc_out sc_lv 13 signal 1 } 
	{ width_c_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ width_c_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ width_c_full_n sc_in sc_logic 1 signal 1 } 
	{ width_c_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "width_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "width_c", "role": "din" }} , 
 	{ "name": "width_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "width_c", "role": "num_data_valid" }} , 
 	{ "name": "width_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "width_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "width_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	width_c { ap_fifo {  { width_c_din fifo_port_we 1 13 }  { width_c_num_data_valid fifo_status_num_data_valid 0 3 }  { width_c_fifo_cap fifo_update 0 3 }  { width_c_full_n fifo_status 0 1 }  { width_c_write fifo_data 1 1 } } }
