...
// 
// ==============================================================
#ifndef XDESIGN_1_V_FRMBUF_WR_0_1_V_FRMBUF_WR_H
#define XDESIGN_1_V_FRMBUF_WR_0_1_V_FRMBUF_WR_H
...
#include <stddef.h>
#endif
#include "xdesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_hw.h"
...
typedef struct {
    u16 DeviceId;
    u32 Design_1_v_frmbuf_wr_0_1_ctrl_BaseAddress;
} XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_Config;
#endif

typedef struct {
    u32 Design_1_v_frmbuf_wr_0_1_ctrl_BaseAddress;
    u32 IsReady;
} XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_ReadReg(BaseAddress, RegOffset) \
...
/************************** Function Prototypes *****************************/
#ifndef __linux__
int XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_Initialize(XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr *InstancePtr, u16 DeviceId);
XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_Config* XDesign_1_v_frmbuf_wr_0_1_v_frmbuf_wr_LookupConfig(u16 DeviceId);
