set moduleName Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1086_1
set isTopModule 0
...
set C_modelName {Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1086_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ mm_video int 64 regular {axi_master 1}  }
	{ sext_ln1086 int 29 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mm_video", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "frm_buffer","offset": { "type": "dynamic","port_name": "frm_buffer","bundle": "CTRL"},"direction": "WRITEONLY"},{"cName": "frm_buffer2","offset": { "type": "dynamic","port_name": "frm_buffer2","bundle": "CTRL"},},{"cName": "frm_buffer3","offset": { "type": "dynamic","port_name": "frm_buffer3","bundle": "CTRL"},}]}]} , 
 	{ "Name" : "sext_ln1086", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bytePlanes_dout sc_in sc_lv 64 signal 3 } 
	{ bytePlanes_num_data_valid sc_in sc_lv 11 signal 3 } 
	{ bytePlanes_fifo_cap sc_in sc_lv 11 signal 3 } 
	...
	{ sext_ln1086 sc_in sc_lv 29 signal 1 } 
	{ loopWidth sc_in sc_lv 13 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1086", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "sext_ln1086", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1086 { ap_none {  { sext_ln1086 in_data 0 29 } } }
