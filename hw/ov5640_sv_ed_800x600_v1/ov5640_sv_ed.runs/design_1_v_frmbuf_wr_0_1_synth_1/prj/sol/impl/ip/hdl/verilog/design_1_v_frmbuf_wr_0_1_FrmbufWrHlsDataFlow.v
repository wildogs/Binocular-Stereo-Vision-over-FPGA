...
module design_1_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow (
        s_axis_video_TDATA,
        s_axis_video_TKEEP,
        s_axis_video_TSTRB,
        s_axis_video_TUSER,
...
design_1_v_frmbuf_wr_0_1_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_wr_0_1_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_wr_0_1_MultiPixStream2Bytes MultiPixStream2Bytes_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_wr_0_1_Bytes2AXIMMvideo Bytes2AXIMMvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_wr_0_1_fifo_w32_d4_S HwReg_frm_buffer_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w15_d3_S WidthInBytes_c9_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w16_d4_S stride_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w6_d3_S video_format_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w24_d2_S img_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w12_d2_S height_c10_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w64_d1024_B bytePlanes_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w15_d2_S WidthInBytes_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_fifo_w12_d2_S height_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_start_for_MultiPixStream2Bytes_U0 start_for_MultiPixStream2Bytes_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_wr_0_1_start_for_Bytes2AXIMMvideo_U0 start_for_Bytes2AXIMMvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //design_1_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow
