...
attribute shreg_extract : string;
    ...
    component design_1_v_frmbuf_wr_0_1_fifo_w64_d1024_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    video_format_c_U : component design_1_v_frmbuf_wr_0_1_fifo_w6_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_U : component design_1_v_frmbuf_wr_0_1_fifo_w64_d1024_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
