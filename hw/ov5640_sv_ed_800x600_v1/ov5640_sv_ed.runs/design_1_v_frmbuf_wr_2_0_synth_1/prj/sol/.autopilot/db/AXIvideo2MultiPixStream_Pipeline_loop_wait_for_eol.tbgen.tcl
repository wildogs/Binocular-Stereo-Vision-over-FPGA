...
set C_modelArgList {
	...
	{ axi_data_4_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_2_lcssa", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_4_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_4_out sc_out sc_lv 24 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_4_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	axi_data_4_out { ap_vld {  { axi_data_4_out out_data 1 24 }  { axi_data_4_out_ap_vld out_vld 1 1 } } }
