...
(* CORE_GENERATION_INFO="design_1_v_frmbuf_wr_2_0_v_frmbuf_wr,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=12,HLS_SYN_DSP=0,HLS_SYN_FF=3003,HLS_SYN_LUT=4144,HLS_VERSION=2023_1}" *)

module design_1_v_frmbuf_wr_2_0_v_frmbuf_wr (
        ap_clk,
        ap_rst_n,
...
wire   [11:0] empty_45_fu_191_p1;
reg   [11:0] empty_45_reg_232;
wire   [12:0] empty_46_fu_195_p1;
reg   [12:0] empty_46_reg_237;
...
design_1_v_frmbuf_wr_2_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
design_1_v_frmbuf_wr_2_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
design_1_v_frmbuf_wr_2_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_160(
...
design_1_v_frmbuf_wr_2_0_CTRL_s_axi #(
...
design_1_v_frmbuf_wr_2_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 105 ),
...
design_1_v_frmbuf_wr_2_0_mul_3ns_15s_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 3 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 15 ))
mul_3ns_15s_15_1_1_U112(
    .din0(mul_ln150_fu_212_p0),
    .din1(trunc_ln150_reg_247),
    .dout(mul_ln150_fu_212_p2)
);

design_1_v_frmbuf_wr_2_0_regslice_both #(
    .DataWidth( 24 ))
...
assign empty_45_fu_191_p1 = height[11:0];

assign empty_46_fu_195_p1 = width[12:0];
...
`include "design_1_v_frmbuf_wr_2_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "design_1_v_frmbuf_wr_2_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //design_1_v_frmbuf_wr_2_0_v_frmbuf_wr
