...
entity design_1_v_frmbuf_wr_2_0_MultiPixStream2Bytes is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of design_1_v_frmbuf_wr_2_0_MultiPixStream2Bytes is 
...
attribute shreg_extract : string;
    ...
    component design_1_v_frmbuf_wr_2_0_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_930_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_930_1_fu_190 : component design_1_v_frmbuf_wr_2_0_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_930_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
