...
entity design_1_v_frmbuf_wr_2_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1086_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of design_1_v_frmbuf_wr_2_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1086_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1086_reg_146 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal icmp_ln1086_fu_112_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal bytePlanes_read_reg_155 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1086_fu_112_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1086_reg_146 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    add_ln1086_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_3) + unsigned(ap_const_lv13_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, bytePlanes_empty_n, icmp_ln1086_reg_146)
    begin
                ap_block_pp0_stage0_01001 <= ((icmp_ln1086_reg_146 = ap_const_lv1_0) and (bytePlanes_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, bytePlanes_empty_n, icmp_ln1086_reg_146, m_axi_mm_video_WREADY)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln1086_reg_146 = ap_const_lv1_0) and (bytePlanes_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((m_axi_mm_video_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, bytePlanes_empty_n, icmp_ln1086_reg_146, m_axi_mm_video_WREADY)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln1086_reg_146 = ap_const_lv1_0) and (bytePlanes_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((m_axi_mm_video_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(bytePlanes_empty_n, icmp_ln1086_reg_146)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln1086_reg_146 = ap_const_lv1_0) and (bytePlanes_empty_n = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1086_fu_112_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1086_fu_112_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1086_reg_146, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln1086_reg_146 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    bytePlanes_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bytePlanes_empty_n, icmp_ln1086_reg_146, ap_block_pp0_stage0)
    begin
        if (((icmp_ln1086_reg_146 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    bytePlanes_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1086_reg_146, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1086_reg_146 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    icmp_ln1086_fu_112_p2 <= "1" when (ap_sig_allocacmp_x_3 = loopWidth) else "0";
    ...
    m_axi_mm_video_WDATA <= bytePlanes_read_reg_155;
