...
entity design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B is
    generic (
...
architecture arch of design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B is

    -- component
    component design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B_ram is
    generic (
        MEM_STYLE  : string  := "block";
...
begin
----------------------- Instantiation -----------------------
    U_design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B_ram : design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B_ram is
    generic (
        MEM_STYLE   : string  := "block";
        DATA_WIDTH  : integer := 64;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of design_1_v_frmbuf_rd_0_1_fifo_w64_d1024_B_ram is
