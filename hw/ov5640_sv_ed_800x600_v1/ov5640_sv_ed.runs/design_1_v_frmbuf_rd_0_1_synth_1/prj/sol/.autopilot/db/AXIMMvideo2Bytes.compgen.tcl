...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_height_c9 \
    op interface \
    ports { height_c9_din { O 12 vector } height_c9_num_data_valid { I 2 vector } height_c9_fifo_cap { I 2 vector } height_c9_full_n { I 1 bit } height_c9_write { O 1 bit } } \
} "
}
