...
architecture behav of stereolbm_axis_cambm is 
    ...
    "stereolbm_axis_cambm_stereolbm_axis_cambm,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.569687,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=181,HLS_SYN_DSP=0,HLS_SYN_FF=61160,HLS_SYN_LUT=79765,HLS_VERSION=2023_1}";
    ...
    signal Loop_VITIS_LOOP_61_1_proc_U0_ap_start : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_ap_done : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_ap_continue : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_ap_idle : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_ap_ready : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_cameraMA_l_fix : STD_LOGIC;
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_full_n : STD_LOGIC;
    ...
    signal Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_full_n : STD_LOGIC;
    ...
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_full_n : STD_LOGIC;
    ...
    signal Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_irA_r_fix : STD_LOGIC := '0';
    signal ap_sync_channel_write_irA_r_fix : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_ap_start : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_ap_done : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_ap_continue : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_ap_idle : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_ap_ready : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_ce0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_we0 : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_distC_l_fix : STD_LOGIC;
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_full_n : STD_LOGIC;
    ...
    signal Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_full_n : STD_LOGIC;
    ...
    signal ap_channel_done_imgR_in_cols_c54_channel : STD_LOGIC;
    signal imgR_in_cols_c54_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_imgR_in_cols_c54_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_imgR_in_cols_c54_channel : STD_LOGIC;
    signal ap_channel_done_imgR_in_rows_c53_channel : STD_LOGIC;
    signal imgR_in_rows_c53_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_imgR_in_rows_c53_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_imgR_in_rows_c53_channel : STD_LOGIC;
    signal ap_channel_done_imgL_in_cols_c52_channel : STD_LOGIC;
    signal imgL_in_cols_c52_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_imgL_in_cols_c52_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_imgL_in_cols_c52_channel : STD_LOGIC;
    signal ap_channel_done_imgL_in_rows_c51_channel : STD_LOGIC;
    signal imgL_in_rows_c51_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_imgL_in_rows_c51_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_imgL_in_rows_c51_channel : STD_LOGIC;
    ...
    signal xfMat2AXIvideo_8_0_600_800_1_2_U0_img_disp8u_data_read : STD_LOGIC;
    ...
    signal imgL_in_rows_c51_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgL_in_rows_c51_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgL_in_rows_c51_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgL_in_rows_c51_channel_empty_n : STD_LOGIC;
    signal imgL_in_cols_c52_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgL_in_cols_c52_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgL_in_cols_c52_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgL_in_cols_c52_channel_empty_n : STD_LOGIC;
    signal imgR_in_rows_c53_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgR_in_rows_c53_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgR_in_rows_c53_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgR_in_rows_c53_channel_empty_n : STD_LOGIC;
    signal imgR_in_cols_c54_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgR_in_cols_c54_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal imgR_in_cols_c54_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal imgR_in_cols_c54_channel_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready : STD_LOGIC;
    signal ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready : STD_LOGIC;
    ...
    component stereolbm_axis_cambm_Loop_VITIS_LOOP_61_1_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component stereolbm_axis_cambm_Loop_VITIS_LOOP_70_2_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_we0,
        i_d0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_d0,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_we0,
        i_d0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_d0,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_we0,
        i_d0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_d0,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_we0,
        i_d0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_d0,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_we0,
        i_d0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_d0,
        i_q0 => irA_l_fix_i_q0,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        i_address0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_address0,
        i_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_ce0,
        i_we0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_we0,
        i_d0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_d0,
        i_q0 => irA_r_fix_i_q0,
    ...
    Loop_VITIS_LOOP_61_1_proc_U0 : component stereolbm_axis_cambm_Loop_VITIS_LOOP_61_1_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Loop_VITIS_LOOP_61_1_proc_U0_ap_start,
        ap_done => Loop_VITIS_LOOP_61_1_proc_U0_ap_done,
        ap_continue => Loop_VITIS_LOOP_61_1_proc_U0_ap_continue,
        ap_idle => Loop_VITIS_LOOP_61_1_proc_U0_ap_idle,
        ap_ready => Loop_VITIS_LOOP_61_1_proc_U0_ap_ready,
        irA_r_fix_address0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_address0,
        irA_r_fix_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_ce0,
        irA_r_fix_we0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_we0,
        irA_r_fix_d0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_d0,
        irA_l_fix_address0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_address0,
        irA_l_fix_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_ce0,
        irA_l_fix_we0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_we0,
        irA_l_fix_d0 => Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_d0,
        cameraMA_r_fix_address0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_address0,
        cameraMA_r_fix_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_ce0,
        cameraMA_r_fix_we0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_we0,
        cameraMA_r_fix_d0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_d0,
        cameraMA_l_fix_address0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_address0,
        cameraMA_l_fix_ce0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_ce0,
        cameraMA_l_fix_we0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_we0,
        cameraMA_l_fix_d0 => Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_d0);

    Loop_VITIS_LOOP_70_2_proc_U0 : component stereolbm_axis_cambm_Loop_VITIS_LOOP_70_2_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Loop_VITIS_LOOP_70_2_proc_U0_ap_start,
        ap_done => Loop_VITIS_LOOP_70_2_proc_U0_ap_done,
        ap_continue => Loop_VITIS_LOOP_70_2_proc_U0_ap_continue,
        ap_idle => Loop_VITIS_LOOP_70_2_proc_U0_ap_idle,
        ap_ready => Loop_VITIS_LOOP_70_2_proc_U0_ap_ready,
        distC_r_fix_address0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_address0,
        distC_r_fix_ce0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_ce0,
        distC_r_fix_we0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_we0,
        distC_r_fix_d0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_d0,
        distC_l_fix_address0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_address0,
        distC_l_fix_ce0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_ce0,
        distC_l_fix_we0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_we0,
        distC_l_fix_d0 => Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_d0);
    ...
    port map (
        ...
        p_read => imgL_in_rows_c51_channel_dout,
        p_read1 => imgL_in_cols_c52_channel_dout,
    ...
    port map (
        ...
        p_read => imgR_in_rows_c53_channel_dout,
        p_read1 => imgR_in_cols_c54_channel_dout,
    ...
    port map (
        ...
        img_disp8u_data_read => xfMat2AXIvideo_8_0_600_800_1_2_U0_img_disp8u_data_read,
    ...
    imgL_in_rows_c51_channel_U : component stereolbm_axis_cambm_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgL_in_rows_c51_channel_full_n,
        if_write => ap_channel_done_imgL_in_rows_c51_channel,
        if_dout => imgL_in_rows_c51_channel_dout,
        if_num_data_valid => imgL_in_rows_c51_channel_num_data_valid,
        if_fifo_cap => imgL_in_rows_c51_channel_fifo_cap,
        if_empty_n => imgL_in_rows_c51_channel_empty_n,
        if_read => AXIvideo2xfMat_8_0_600_800_1_2_1_U0_ap_ready);

    imgL_in_cols_c52_channel_U : component stereolbm_axis_cambm_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgL_in_cols_c52_channel_full_n,
        if_write => ap_channel_done_imgL_in_cols_c52_channel,
        if_dout => imgL_in_cols_c52_channel_dout,
        if_num_data_valid => imgL_in_cols_c52_channel_num_data_valid,
        if_fifo_cap => imgL_in_cols_c52_channel_fifo_cap,
        if_empty_n => imgL_in_cols_c52_channel_empty_n,
        if_read => AXIvideo2xfMat_8_0_600_800_1_2_1_U0_ap_ready);

    imgR_in_rows_c53_channel_U : component stereolbm_axis_cambm_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgR_in_rows_c53_channel_full_n,
        if_write => ap_channel_done_imgR_in_rows_c53_channel,
        if_dout => imgR_in_rows_c53_channel_dout,
        if_num_data_valid => imgR_in_rows_c53_channel_num_data_valid,
        if_fifo_cap => imgR_in_rows_c53_channel_fifo_cap,
        if_empty_n => imgR_in_rows_c53_channel_empty_n,
        if_read => AXIvideo2xfMat_8_0_600_800_1_2_U0_ap_ready);

    imgR_in_cols_c54_channel_U : component stereolbm_axis_cambm_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgR_in_cols_c54_channel_full_n,
        if_write => ap_channel_done_imgR_in_cols_c54_channel,
        if_dout => imgR_in_cols_c54_channel_dout,
        if_num_data_valid => imgR_in_cols_c54_channel_num_data_valid,
        if_fifo_cap => imgR_in_cols_c54_channel_fifo_cap,
        if_empty_n => imgR_in_cols_c54_channel_empty_n,
        if_read => AXIvideo2xfMat_8_0_600_800_1_2_U0_ap_ready);
    ...
    port map (
        ...
        if_read => xfMat2AXIvideo_8_0_600_800_1_2_U0_img_disp8u_data_read);
    ...
    ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready <= ap_sync_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready <= ap_sync_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((Loop_VITIS_LOOP_61_1_proc_U0_ap_done and Loop_VITIS_LOOP_61_1_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_cameraMA_l_fix <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((Loop_VITIS_LOOP_70_2_proc_U0_ap_done and Loop_VITIS_LOOP_70_2_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_distC_l_fix <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_channel_write_imgL_in_cols_c52_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_imgL_in_cols_c52_channel <= ap_const_logic_0;
            else
                if (((Block_for_end72_proc_U0_ap_done and Block_for_end72_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_imgL_in_cols_c52_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_imgL_in_cols_c52_channel <= ap_sync_channel_write_imgL_in_cols_c52_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_channel_write_imgL_in_rows_c51_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_imgL_in_rows_c51_channel <= ap_const_logic_0;
            else
                if (((Block_for_end72_proc_U0_ap_done and Block_for_end72_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_imgL_in_rows_c51_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_imgL_in_rows_c51_channel <= ap_sync_channel_write_imgL_in_rows_c51_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_channel_write_imgR_in_cols_c54_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_imgR_in_cols_c54_channel <= ap_const_logic_0;
            else
                if (((Block_for_end72_proc_U0_ap_done and Block_for_end72_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_imgR_in_cols_c54_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_imgR_in_cols_c54_channel <= ap_sync_channel_write_imgR_in_cols_c54_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_channel_write_imgR_in_rows_c53_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_imgR_in_rows_c53_channel <= ap_const_logic_0;
            else
                if (((Block_for_end72_proc_U0_ap_done and Block_for_end72_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_imgR_in_rows_c53_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_imgR_in_rows_c53_channel <= ap_sync_channel_write_imgR_in_rows_c53_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    AXIvideo2xfMat_8_0_600_800_1_2_1_U0_ap_start <= (imgL_in_rows_c51_channel_empty_n and imgL_in_cols_c52_channel_empty_n);
    AXIvideo2xfMat_8_0_600_800_1_2_U0_ap_continue <= ap_const_logic_1;
    AXIvideo2xfMat_8_0_600_800_1_2_U0_ap_start <= (imgR_in_rows_c53_channel_empty_n and imgR_in_cols_c54_channel_empty_n);
    ...
    Loop_VITIS_LOOP_61_1_proc_U0_ap_continue <= (ap_sync_channel_write_irA_r_fix and ap_sync_channel_write_irA_l_fix and ap_sync_channel_write_cameraMA_r_fix and ap_sync_channel_write_cameraMA_l_fix);
    Loop_VITIS_LOOP_61_1_proc_U0_ap_start <= ((ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_full_n <= cameraMA_l_fix_i_full_n;
    Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_full_n <= cameraMA_r_fix_i_full_n;
    Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_full_n <= irA_l_fix_i_full_n;
    Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_full_n <= irA_r_fix_i_full_n;
    Loop_VITIS_LOOP_70_2_proc_U0_ap_continue <= (ap_sync_channel_write_distC_r_fix and ap_sync_channel_write_distC_l_fix);
    Loop_VITIS_LOOP_70_2_proc_U0_ap_start <= ((ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_full_n <= distC_l_fix_i_full_n;
    Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_full_n <= distC_r_fix_i_full_n;
    ...
    ap_channel_done_cameraMA_l_fix <= ((ap_sync_reg_channel_write_cameraMA_l_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_61_1_proc_U0_ap_done);
    ap_channel_done_cameraMA_r_fix <= ((ap_sync_reg_channel_write_cameraMA_r_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_61_1_proc_U0_ap_done);
    ap_channel_done_distC_l_fix <= ((ap_sync_reg_channel_write_distC_l_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_70_2_proc_U0_ap_done);
    ap_channel_done_distC_r_fix <= ((ap_sync_reg_channel_write_distC_r_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_70_2_proc_U0_ap_done);
    ap_channel_done_imgL_in_cols_c52_channel <= ((ap_sync_reg_channel_write_imgL_in_cols_c52_channel xor ap_const_logic_1) and Block_for_end72_proc_U0_ap_done);
    ap_channel_done_imgL_in_rows_c51_channel <= ((ap_sync_reg_channel_write_imgL_in_rows_c51_channel xor ap_const_logic_1) and Block_for_end72_proc_U0_ap_done);
    ap_channel_done_imgR_in_cols_c54_channel <= ((ap_sync_reg_channel_write_imgR_in_cols_c54_channel xor ap_const_logic_1) and Block_for_end72_proc_U0_ap_done);
    ap_channel_done_imgR_in_rows_c53_channel <= ((ap_sync_reg_channel_write_imgR_in_rows_c53_channel xor ap_const_logic_1) and Block_for_end72_proc_U0_ap_done);
    ...
    ap_channel_done_irA_l_fix <= ((ap_sync_reg_channel_write_irA_l_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_61_1_proc_U0_ap_done);
    ap_channel_done_irA_r_fix <= ((ap_sync_reg_channel_write_irA_r_fix xor ap_const_logic_1) and Loop_VITIS_LOOP_61_1_proc_U0_ap_done);
    ...
    ap_done <= xfMat2AXIvideo_8_0_600_800_1_2_U0_ap_done;
    ap_idle <= (xfMat2AXIvideo_8_0_600_800_1_2_U0_ap_idle and remap_128_1_0_7_0_600_800_1_false_2_2_2_2_U0_ap_idle and remap_128_1_0_7_0_600_800_1_false_2_2_2_2_2_U0_ap_idle and (rightRemappedMat_cols_empty_n xor ap_const_logic_1) and (rightRemappedMat_rows_empty_n xor ap_const_logic_1) and (leftRemappedMat_cols_empty_n xor ap_const_logic_1) and (leftRemappedMat_rows_empty_n xor ap_const_logic_1) and (bmState_textureThreshold_empty_n xor ap_const_logic_1) and (bmState_uniquenessRatio_empty_n xor ap_const_logic_1) and (bmState_preFilterCap_empty_n xor ap_const_logic_1) and (imgR_in_cols_c54_channel_empty_n xor ap_const_logic_1) and (imgR_in_rows_c53_channel_empty_n xor ap_const_logic_1) and (imgL_in_cols_c52_channel_empty_n xor ap_const_logic_1) and (imgL_in_rows_c51_channel_empty_n xor ap_const_logic_1) and (mapxRMat_cols_empty_n xor ap_const_logic_1) and (mapxRMat_rows_empty_n xor ap_const_logic_1) and (mapxLMat_cols_empty_n xor ap_const_logic_1) and (mapxLMat_rows_empty_n xor ap_const_logic_1) and (distC_l_fix_t_empty_n xor 
    ap_const_logic_1) and (distC_r_fix_t_empty_n xor ap_const_logic_1) and (cameraMA_l_fix_t_empty_n xor ap_const_logic_1) and (cameraMA_r_fix_t_empty_n xor ap_const_logic_1) and (irA_l_fix_t_empty_n xor ap_const_logic_1) and (irA_r_fix_t_empty_n xor ap_const_logic_1) and (img_disp8u_cols_empty_n xor ap_const_logic_1) and (img_disp8u_rows_empty_n xor ap_const_logic_1) and StereoBM_15_128_16_0_2_600_800_1_false_2_2_2_U0_ap_idle and Loop_VITIS_LOOP_70_2_proc_U0_ap_idle and Loop_VITIS_LOOP_61_1_proc_U0_ap_idle and InitUndistortRectifyMapInverse_9_5_7_600_800_1_2_2_U0_ap_idle and InitUndistortRectifyMapInverse_9_5_7_600_800_1_2_2_7_U0_ap_idle and ConvertShiftAbs_U0_ap_idle and Block_for_end72_proc_U0_ap_idle and Block_for_end7235_proc_U0_ap_idle and AXIvideo2xfMat_8_0_600_800_1_2_U0_ap_idle and AXIvideo2xfMat_8_0_600_800_1_2_1_U0_ap_idle);
    ...
    ap_sync_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready <= (ap_sync_reg_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready or Loop_VITIS_LOOP_61_1_proc_U0_ap_ready);
    ap_sync_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready <= (ap_sync_reg_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready or Loop_VITIS_LOOP_70_2_proc_U0_ap_ready);
    ...
    ap_sync_channel_write_cameraMA_l_fix <= ((ap_channel_done_cameraMA_l_fix and Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_l_fix_full_n) or ap_sync_reg_channel_write_cameraMA_l_fix);
    ap_sync_channel_write_cameraMA_r_fix <= ((ap_channel_done_cameraMA_r_fix and Loop_VITIS_LOOP_61_1_proc_U0_cameraMA_r_fix_full_n) or ap_sync_reg_channel_write_cameraMA_r_fix);
    ap_sync_channel_write_distC_l_fix <= ((ap_channel_done_distC_l_fix and Loop_VITIS_LOOP_70_2_proc_U0_distC_l_fix_full_n) or ap_sync_reg_channel_write_distC_l_fix);
    ap_sync_channel_write_distC_r_fix <= ((ap_channel_done_distC_r_fix and Loop_VITIS_LOOP_70_2_proc_U0_distC_r_fix_full_n) or ap_sync_reg_channel_write_distC_r_fix);
    ap_sync_channel_write_imgL_in_cols_c52_channel <= ((imgL_in_cols_c52_channel_full_n and ap_channel_done_imgL_in_cols_c52_channel) or ap_sync_reg_channel_write_imgL_in_cols_c52_channel);
    ap_sync_channel_write_imgL_in_rows_c51_channel <= ((imgL_in_rows_c51_channel_full_n and ap_channel_done_imgL_in_rows_c51_channel) or ap_sync_reg_channel_write_imgL_in_rows_c51_channel);
    ap_sync_channel_write_imgR_in_cols_c54_channel <= ((imgR_in_cols_c54_channel_full_n and ap_channel_done_imgR_in_cols_c54_channel) or ap_sync_reg_channel_write_imgR_in_cols_c54_channel);
    ap_sync_channel_write_imgR_in_rows_c53_channel <= ((imgR_in_rows_c53_channel_full_n and ap_channel_done_imgR_in_rows_c53_channel) or ap_sync_reg_channel_write_imgR_in_rows_c53_channel);
    ...
    ap_sync_channel_write_irA_l_fix <= ((ap_channel_done_irA_l_fix and Loop_VITIS_LOOP_61_1_proc_U0_irA_l_fix_full_n) or ap_sync_reg_channel_write_irA_l_fix);
    ap_sync_channel_write_irA_r_fix <= ((ap_channel_done_irA_r_fix and Loop_VITIS_LOOP_61_1_proc_U0_irA_r_fix_full_n) or ap_sync_reg_channel_write_irA_r_fix);
    ...
    ap_sync_ready <= (ap_sync_Loop_VITIS_LOOP_70_2_proc_U0_ap_ready and ap_sync_Loop_VITIS_LOOP_61_1_proc_U0_ap_ready and ap_sync_Block_for_end72_proc_U0_ap_ready and ap_sync_Block_for_end7235_proc_U0_ap_ready);
    ...
    xfMat2AXIvideo_8_0_600_800_1_2_U0_ap_start <= (img_disp8u_rows_empty_n and img_disp8u_cols_empty_n);
end behav;
