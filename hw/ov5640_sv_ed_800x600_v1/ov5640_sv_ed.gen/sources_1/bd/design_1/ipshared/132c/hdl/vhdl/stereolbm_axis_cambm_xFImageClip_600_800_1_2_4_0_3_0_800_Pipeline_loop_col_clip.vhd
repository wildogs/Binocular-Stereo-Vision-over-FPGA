...
entity stereolbm_axis_cambm_xFImageClip_600_800_1_2_4_0_3_0_800_Pipeline_loop_col_clip is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of stereolbm_axis_cambm_xFImageClip_600_800_1_2_4_0_3_0_800_Pipeline_loop_col_clip is 
...
attribute shreg_extract : string;
    ...
    signal in_sobel_x_data_1_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal right_clipped_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_8_reg_239 : STD_LOGIC_VECTOR (14 downto 0);
    signal j_8_reg_239_pp0_iter1_reg : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal ap_sig_allocacmp_j_8 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal trunc_ln645_1_fu_175_p1 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                j_8_reg_239 <= ap_sig_allocacmp_j_8;
                j_8_reg_239_pp0_iter1_reg <= j_8_reg_239;
                tmp_reg_248 <= in_sobel_x_data_1_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln630_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_8) + unsigned(ap_const_lv15_1));
    add_ln645_fu_157_p2 <= std_logic_vector(unsigned(trunc_ln645_fu_153_p1) + unsigned(cap_cast_i));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter4, in_sobel_x_data_1_empty_n, right_clipped_full_n)
    begin
                ap_block_pp0_stage0_01001 <= (((right_clipped_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1)) or ((in_sobel_x_data_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter4, in_sobel_x_data_1_empty_n, right_clipped_full_n)
    begin
                ap_block_pp0_stage0_11001 <= (((right_clipped_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1)) or ((in_sobel_x_data_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter4, in_sobel_x_data_1_empty_n, right_clipped_full_n)
    begin
                ap_block_pp0_stage0_subdone <= (((right_clipped_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1)) or ((in_sobel_x_data_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(in_sobel_x_data_1_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (in_sobel_x_data_1_empty_n = ap_const_logic_0);
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state4_pp0_stage0_iter3 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state5_pp0_stage0_iter4_assign_proc : process(right_clipped_full_n)
    begin
                ap_block_state5_pp0_stage0_iter4 <= (right_clipped_full_n = ap_const_logic_0);
    end process;
    ...
    ap_sig_allocacmp_j_8_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_fu_62, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_8 <= ap_const_lv15_0;
        else 
            ap_sig_allocacmp_j_8 <= j_fu_62;
        end if; 
    end process;
    ...
    in_sobel_x_data_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, in_sobel_x_data_1_empty_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            in_sobel_x_data_1_blk_n <= in_sobel_x_data_1_empty_n;
        else 
            in_sobel_x_data_1_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    in_sobel_x_data_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            in_sobel_x_data_1_read <= ap_const_logic_1;
        else 
    ...
    right_clipped_blk_n_assign_proc : process(ap_enable_reg_pp0_iter4, right_clipped_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1))) then 
            right_clipped_blk_n <= right_clipped_full_n;
        else 
            right_clipped_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    right_clipped_din <= p_reg_263;

    right_clipped_write_assign_proc : process(ap_enable_reg_pp0_iter4, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1))) then 
            right_clipped_write <= ap_const_logic_1;
        else 
    ...
    shl_ln_fu_178_p3 <= (trunc_ln645_1_fu_175_p1 & ap_const_lv1_0);
    trunc_ln645_1_fu_175_p1 <= sbmstate_preFilterCap_load(7 - 1 downto 0);
    ...
    zext_ln630_fu_132_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_8),16));
end behav;
