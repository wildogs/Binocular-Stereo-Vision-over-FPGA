...
attribute shreg_extract : string;
    ...
    signal col_reg_588 : STD_LOGIC_VECTOR (12 downto 0);
    signal col_reg_588_pp0_iter1_reg : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal col_4_fu_92 : STD_LOGIC_VECTOR (12 downto 0);
    signal col_5_fu_376_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    col_4_fu_92_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    ap_sig_allocacmp_col_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, col_4_fu_92, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_col <= ap_const_lv13_0;
        else 
    ...
    col_5_fu_376_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_col) + unsigned(ap_const_lv13_1));
    ...
    icmp_ln250_fu_405_p2 <= "1" when (col_reg_588_pp0_iter1_reg = ap_const_lv13_0) else "0";
    ...
    zext_ln225_fu_366_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_col),16));
    zext_ln231_fu_393_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(col_reg_588),64));
    zext_ln233_fu_387_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(col_reg_588),64));
    zext_ln234_fu_399_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(col_reg_588_pp0_iter1_reg),64));
end behav;
