...
assign process_axis_block_vec[3] = idx1_block & (1'b0 | axis_block_sigs[2] | axis_block_sigs[1] | axis_block_sigs[0]);
assign process_idle_vec[3] = inst_idle_sigs[3];
assign process_chan_block_vec[3] = inst_block_sigs[3];
assign process_axis_block_vec[4] = idx5_block & (1'b0 | axis_block_sigs[4] | axis_block_sigs[3] | axis_block_sigs[5]);
