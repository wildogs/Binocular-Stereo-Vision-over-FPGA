...
entity stereolbm_axis_cambm_InitUndistortRectifyMapInverse_9_5_7_600_800_1_2_2_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of stereolbm_axis_cambm_InitUndistortRectifyMapInverse_9_5_7_600_800_1_2_2_7 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln249_3_fu_60_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal trunc_ln249_3_reg_69 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                trunc_ln249_3_reg_69 <= trunc_ln249_3_fu_60_p1;
    ...
    mapxRMat_data_write_assign_proc : process(grp_xFInitUndistortRectifyMapInverseKernel_fu_40_mapxRMat_data_write, ap_CS_fsm_state3)
    begin
    ...
    mapyRMat_data_write_assign_proc : process(grp_xFInitUndistortRectifyMapInverseKernel_fu_40_mapyRMat_data_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            mapyRMat_data_write <= grp_xFInitUndistortRectifyMapInverseKernel_fu_40_mapyRMat_data_write;
        else 
    ...
    trunc_ln249_3_fu_60_p1 <= p_read1(16 - 1 downto 0);
