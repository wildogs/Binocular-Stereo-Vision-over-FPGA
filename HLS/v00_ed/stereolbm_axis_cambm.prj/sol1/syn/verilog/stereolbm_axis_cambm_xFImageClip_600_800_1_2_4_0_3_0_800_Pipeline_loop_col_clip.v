...
module stereolbm_axis_cambm_xFImageClip_600_800_1_2_4_0_3_0_800_Pipeline_loop_col_clip (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg    in_sobel_x_data_1_blk_n;
wire    ap_block_pp0_stage0;
reg    right_clipped_blk_n;
reg    ap_block_pp0_stage0_11001;
reg   [14:0] j_8_reg_239;
reg   [14:0] j_8_reg_239_pp0_iter1_reg;
...
wire   [6:0] trunc_ln645_1_fu_175_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        in_sobel_x_data_1_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_sobel_x_data_1_read = 1'b1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        ...
        right_clipped_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        right_clipped_write = 1'b1;
    end else begin
...
assign add_ln630_fu_142_p2 = (ap_sig_allocacmp_j_8 + 15'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((right_clipped_full_n == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b1)) | ((in_sobel_x_data_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((right_clipped_full_n == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b1)) | ((in_sobel_x_data_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((right_clipped_full_n == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b1)) | ((in_sobel_x_data_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (in_sobel_x_data_1_empty_n == 1'b0);
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter4 = (right_clipped_full_n == 1'b0);
end
...
assign right_clipped_din = p_reg_263;
...
assign shl_ln_fu_178_p3 = {{trunc_ln645_1_fu_175_p1}, {1'd0}};

assign trunc_ln645_1_fu_175_p1 = sbmstate_preFilterCap_load[6:0];
...
assign zext_ln630_fu_132_p1 = ap_sig_allocacmp_j_8;

endmodule //stereolbm_axis_cambm_xFImageClip_600_800_1_2_4_0_3_0_800_Pipeline_loop_col_clip
