set moduleName xFRemapLI_0_0_1_7_128_600_800_1_2_2_2_2_false_6_Pipeline_2
set isTopModule 0
...
set C_modelName {xFRemapLI<0, 0, 1, 7, 128, 600, 800, 1, 2, 2, 2, 2, false>.6_Pipeline_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ r2 int 17 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "r2", "interface" : "memory", "bitwidth" : 17, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	r2 { ap_memory {  { r2_address0 mem_address 1 7 }  { r2_ce0 mem_ce 1 1 }  { r2_we0 mem_we 1 1 }  { r2_d0 mem_din 1 17 } } }
}
