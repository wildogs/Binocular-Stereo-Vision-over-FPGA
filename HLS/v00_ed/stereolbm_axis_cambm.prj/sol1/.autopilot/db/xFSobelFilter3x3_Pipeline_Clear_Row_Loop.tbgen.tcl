...
set C_modelArgList {
	...
	{ buf_r int 8 regular {array 800 { 3 0 } 0 1 }  }
...
set portList { 
	...
	{ rightRemappedMat_data_dout sc_in sc_lv 8 signal 3 } 
	{ rightRemappedMat_data_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ rightRemappedMat_data_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ rightRemappedMat_data_empty_n sc_in sc_logic 1 signal 3 } 
	{ rightRemappedMat_data_read sc_out sc_logic 1 signal 3 } 
...
set Spec2ImplPortList { 
	...
	buf_r { ap_memory {  { buf_r_address1 MemPortADDR2 1 10 }  { buf_r_ce1 MemPortCE2 1 1 }  { buf_r_we1 MemPortWE2 1 1 }  { buf_r_d1 MemPortDIN2 1 8 } } }
