set moduleName Sobel_0_3_0_3_600_800_1_false_2_2_2_s
set isTopModule 0
...
set C_modelName {Sobel<0, 3, 0, 3, 600, 800, 1, false, 2, 2, 2>}
...
set portList { 
	...
	{ rightRemappedMat_data_dout sc_in sc_lv 8 signal 2 } 
	{ rightRemappedMat_data_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ rightRemappedMat_data_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ rightRemappedMat_data_empty_n sc_in sc_logic 1 signal 2 } 
	{ rightRemappedMat_data_read sc_out sc_logic 1 signal 2 } 
	{ in_sobel_x_i_data_din sc_out sc_lv 16 signal 3 } 
	{ in_sobel_x_i_data_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ in_sobel_x_i_data_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ in_sobel_x_i_data_full_n sc_in sc_logic 1 signal 3 } 
	{ in_sobel_x_i_data_write sc_out sc_logic 1 signal 3 } 
	{ in_sobel_y_i_data_din sc_out sc_lv 16 signal 4 } 
	{ in_sobel_y_i_data_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ in_sobel_y_i_data_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ in_sobel_y_i_data_full_n sc_in sc_logic 1 signal 4 } 
	{ in_sobel_y_i_data_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "in_sobel_x_i_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
			...
			{"Name" : "in_sobel_y_i_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
