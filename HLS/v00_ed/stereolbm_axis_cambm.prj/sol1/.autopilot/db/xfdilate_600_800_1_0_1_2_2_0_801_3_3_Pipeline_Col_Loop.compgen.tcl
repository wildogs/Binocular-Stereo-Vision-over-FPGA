...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln261_2 \
    op interface \
    ports { trunc_ln261_2 { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln261_1 \
    op interface \
    ports { trunc_ln261_1 { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_disp8u_erode_data_dout { I 8 vector } img_disp8u_erode_data_num_data_valid { I 2 vector } img_disp8u_erode_data_fifo_cap { I 2 vector } img_disp8u_erode_data_empty_n { I 1 bit } img_disp8u_erode_data_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_cmp_i_i131_i \
    op interface \
    ports { cmp_i_i131_i { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 633 \
    name img_disp8u_dilate_data \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_img_disp8u_dilate_data \
    op interface \
    ports { img_disp8u_dilate_data_din { O 8 vector } img_disp8u_dilate_data_num_data_valid { I 2 vector } img_disp8u_dilate_data_fifo_cap { I 2 vector } img_disp8u_dilate_data_full_n { I 1 bit } img_disp8u_dilate_data_write { O 1 bit } } \
} "
}
