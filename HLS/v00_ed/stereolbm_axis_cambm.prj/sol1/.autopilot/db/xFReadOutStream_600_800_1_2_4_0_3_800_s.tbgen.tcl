set moduleName xFReadOutStream_600_800_1_2_4_0_3_800_s
set isTopModule 0
...
set C_modelName {xFReadOutStream<600, 800, 1, 2, 4, 0, 3, 800>}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_sobel_y_i_data int 16 regular {fifo 0 volatile }  }
	{ height int 16 regular {fifo 0}  }
	{ width int 16 regular {fifo 0}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "in_sobel_y_i_data", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_sobel_y_i_data_dout sc_in sc_lv 16 signal 0 } 
	{ in_sobel_y_i_data_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ in_sobel_y_i_data_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ in_sobel_y_i_data_empty_n sc_in sc_logic 1 signal 0 } 
	{ in_sobel_y_i_data_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_sobel_y_i_data_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_sobel_y_i_data", "role": "dout" }} , 
 	...
 	{ "name": "in_sobel_y_i_data_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_sobel_y_i_data", "role": "empty_n" }} , 
 	{ "name": "in_sobel_y_i_data_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_sobel_y_i_data", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "in_sobel_y_i_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_xFReadOutStream_600_800_1_2_4_0_3_800_Pipeline_loop_col_clip_fu_62", "Port" : "in_sobel_y_i_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_xFReadOutStream_600_800_1_2_4_0_3_800_Pipeline_loop_col_clip_fu_62", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_xFReadOutStream_600_800_1_2_4_0_3_800_Pipeline_loop_col_clip_fu_62.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "482401", "Max" : "482401"}
	, {"Name" : "Interval", "Min" : "482401", "Max" : "482401"}
]}
...
set Spec2ImplPortList { 
	in_sobel_y_i_data { ap_fifo {  { in_sobel_y_i_data_dout fifo_port_we 0 16 }  { in_sobel_y_i_data_num_data_valid fifo_status_num_data_valid 0 2 }  { in_sobel_y_i_data_fifo_cap fifo_update 0 2 }  { in_sobel_y_i_data_empty_n fifo_status 0 1 }  { in_sobel_y_i_data_read fifo_data 1 1 } } }
