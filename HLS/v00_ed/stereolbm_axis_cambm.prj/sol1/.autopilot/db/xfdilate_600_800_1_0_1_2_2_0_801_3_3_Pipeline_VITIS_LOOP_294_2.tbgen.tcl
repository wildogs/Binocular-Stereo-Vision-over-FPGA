set moduleName xfdilate_600_800_1_0_1_2_2_0_801_3_3_Pipeline_VITIS_LOOP_294_2
set isTopModule 0
...
set C_modelName {xfdilate<600, 800, 1, 0, 1, 2, 2, 0, 801, 3, 3>_Pipeline_VITIS_LOOP_294_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_width int 16 regular  }
	{ buf_1 int 8 regular {array 800 { 3 0 } 0 1 }  }
...
set portList { 
	...
	{ buf_1_address1 sc_out sc_lv 10 signal 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "803"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "803"}
]}
...
set Spec2ImplPortList { 
	...
	buf_1 { ap_memory {  { buf_1_address1 MemPortADDR2 1 10 }  { buf_1_ce1 MemPortCE2 1 1 }  { buf_1_we1 MemPortWE2 1 1 }  { buf_1_d1 MemPortDIN2 1 8 } } }
