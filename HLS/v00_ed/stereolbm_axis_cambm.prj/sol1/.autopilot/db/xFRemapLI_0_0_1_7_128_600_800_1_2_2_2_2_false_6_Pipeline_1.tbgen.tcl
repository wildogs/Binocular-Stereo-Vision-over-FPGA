set moduleName xFRemapLI_0_0_1_7_128_600_800_1_2_2_2_2_false_6_Pipeline_1
set isTopModule 0
...
set C_modelName {xFRemapLI<0, 0, 1, 7, 128, 600, 800, 1, 2, 2, 2, 2, false>.6_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ r1 int 17 regular {array 128 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ r1_address0 sc_out sc_lv 7 signal 0 } 
...
set Spec2ImplPortList { 
	r1 { ap_memory {  { r1_address0 mem_address 1 7 }  { r1_ce0 mem_ce 1 1 }  { r1_we0 mem_we 1 1 }  { r1_d0 mem_din 1 17 } } }
}
