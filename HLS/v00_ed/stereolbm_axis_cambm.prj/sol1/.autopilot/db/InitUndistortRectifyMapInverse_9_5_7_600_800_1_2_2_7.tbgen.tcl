set moduleName InitUndistortRectifyMapInverse_9_5_7_600_800_1_2_2_7
set isTopModule 0
...
set C_modelName {InitUndistortRectifyMapInverse<9, 5, 7, 600, 800, 1, 2, 2>.7}
...
set portList { 
	...
	{ mapxRMat_data_din sc_out sc_lv 32 signal 5 } 
	{ mapxRMat_data_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ mapxRMat_data_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ mapxRMat_data_full_n sc_in sc_logic 1 signal 5 } 
	{ mapxRMat_data_write sc_out sc_logic 1 signal 5 } 
	{ mapyRMat_data_din sc_out sc_lv 32 signal 6 } 
	{ mapyRMat_data_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ mapyRMat_data_fifo_cap sc_in sc_lv 2 signal 6 } 
	{ mapyRMat_data_full_n sc_in sc_logic 1 signal 6 } 
	{ mapyRMat_data_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "mapxRMat_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_xFInitUndistortRectifyMapInverseKernel_fu_40", "Port" : "mapxRMat_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "mapyRMat_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
