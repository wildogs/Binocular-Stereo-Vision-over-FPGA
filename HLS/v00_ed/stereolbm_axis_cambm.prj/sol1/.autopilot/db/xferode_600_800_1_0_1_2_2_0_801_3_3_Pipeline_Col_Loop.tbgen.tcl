set moduleName xferode_600_800_1_0_1_2_2_0_801_3_3_Pipeline_Col_Loop
set isTopModule 0
...
set C_modelName {xferode<600, 800, 1, 0, 1, 2, 2, 0, 801, 3, 3>_Pipeline_Col_Loop}
...
set C_modelArgList {
	...
	{ trunc_ln265_2 int 2 regular  }
	{ trunc_ln265_1 int 2 regular  }
	{ trunc_ln int 2 regular  }
	{ img_disp8u_data int 8 regular {fifo 0 volatile }  }
	{ cmp_i_i142_i int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "img_width", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "trunc_ln265_2", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln265_1", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "cmp_i_i142_i", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ img_disp8u_data_dout sc_in sc_lv 8 signal 7 } 
	{ img_disp8u_data_num_data_valid sc_in sc_lv 2 signal 7 } 
	{ img_disp8u_data_fifo_cap sc_in sc_lv 2 signal 7 } 
	{ img_disp8u_data_empty_n sc_in sc_logic 1 signal 7 } 
	{ img_disp8u_data_read sc_out sc_logic 1 signal 7 } 
	{ img_disp8u_erode_data_din sc_out sc_lv 8 signal 9 } 
	{ img_disp8u_erode_data_num_data_valid sc_in sc_lv 2 signal 9 } 
	{ img_disp8u_erode_data_fifo_cap sc_in sc_lv 2 signal 9 } 
	{ img_disp8u_erode_data_full_n sc_in sc_logic 1 signal 9 } 
	{ img_disp8u_erode_data_write sc_out sc_logic 1 signal 9 } 
	...
	{ trunc_ln265_2 sc_in sc_lv 2 signal 4 } 
	{ trunc_ln265_1 sc_in sc_lv 2 signal 5 } 
	{ trunc_ln sc_in sc_lv 2 signal 6 } 
	{ cmp_i_i142_i sc_in sc_lv 1 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln265_2", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "trunc_ln265_2", "role": "default" }} , 
 	{ "name": "trunc_ln265_1", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "trunc_ln265_1", "role": "default" }} , 
 	{ "name": "trunc_ln", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "trunc_ln", "role": "default" }} , 
 	{ "name": "cmp_i_i142_i", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "cmp_i_i142_i", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.src_buf_temp_copy_extract_0_3_xfExtractPixels_1_1_0_s_fu_295", "Parent" : "0",
		"CDFG" : "xfExtractPixels_1_1_0_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "val1_val", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.src_buf_temp_copy_extract_0_4_xfExtractPixels_1_1_0_s_fu_301", "Parent" : "0",
		"CDFG" : "xfExtractPixels_1_1_0_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "val1_val", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_3_2_8_1_1_U592", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_3_2_8_1_1_U593", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_3_2_8_1_1_U594", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	trunc_ln265_2 { ap_none {  { trunc_ln265_2 in_data 0 2 } } }
	trunc_ln265_1 { ap_none {  { trunc_ln265_1 in_data 0 2 } } }
	...
	cmp_i_i142_i { ap_none {  { cmp_i_i142_i in_data 0 1 } } }
